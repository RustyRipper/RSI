 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://example.org/", wsdlLocation = "file:/C:/git_projects/RSI/jaxws2/src/main/resources/personservice.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/git_projects/RSI/jaxws2/src/main/resources/personservice.wsdl");
